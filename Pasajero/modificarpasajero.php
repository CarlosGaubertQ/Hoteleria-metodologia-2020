...
<main>
  <div class="container" style="margin-top:3rem">
    <h1 align="center"><b><u><i>Modificar pasajero</i></u></b></h1>
    <br>
    <p>Hola! Bienvenido/a, este este apartado te permitira modificar los datos de los pasajeros</p>
  ...
  <div class="container" style="margin-top:3rem;margin-bottom:3rem" align="left">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-4" style="margin-top:1rem">
        ...
        <input type="hidden" name="id" value="<?php echo $_GET['dni']; ?>"/>
        <input width="15%" type="image" alt="submit"  src="../img/validar.png" /> 
      </div>
    </div>
  </div>
</form>
