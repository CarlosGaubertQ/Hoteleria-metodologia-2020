...
<main>
  ...
  <div class="container" align="center">
      <a href="nuevaestadia.php"><img src="../img/estrella.png" width=3%>Crear nueva reserva</a>
      <hr>
  </div>
</main>
        ...
        ?>
          <div class="container">
              <div class="alert alert-danger" role="alert" align="center">
                <b>-- Datos anulados correctamente --</b>
              </div>
            </div>
        <?php
      break;
      case '2':
        ...
        <div class="container">
              <div class="alert alert-success" role="alert" align="center">
                <b>-- Registro de salida guardado exitosamente. --</b>
              </div>
            </div>
        <?php
      break;
